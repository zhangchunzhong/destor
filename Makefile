...
DESTORLIB_SRC = src/utils/bloom_filter.c  src/utils/lru_cache.c  src/utils/queue.c  src/utils/sds.c \
		...
		src/phase/read_phase.c  src/phase/rewrite_phase.c  src/phase/trace_phase.c \
